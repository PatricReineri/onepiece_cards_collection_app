...
class AllValuableCardsPage extends StatefulWidget {
  ...
  @override
  State<AllValuableCardsPage> createState() => _AllValuableCardsPageState();
}

class _AllValuableCardsPageState extends State<AllValuableCardsPage> {
  final CardController _controller = CardController();

  @override
  void initState() {
    super.initState();
    _controller.loadAllExpensiveCards();
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: Center(
              child: Text(
                '${_controller.expensiveCards.length} cards',
                style: TextStyle(
  ...
  Widget _buildBody() {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ElevatedButton(
              onPressed: _controller.loadAllExpensiveCards,
    ...
    if (_controller.expensiveCards.isEmpty) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.money_off, size: 64, color: AppColors.textMuted),
            const SizedBox(height: 16),
            Text(
    ...
    return RefreshIndicator(
      onRefresh: _controller.loadAllExpensiveCards,
      ...
      child: GridView.builder(
        ...
        itemCount: _controller.expensiveCards.length,
